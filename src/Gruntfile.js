    ...
    tv4: {
      ...
      options: {
        schemas: {
          ...
          "library-cdnjs.json": grunt.file.readJSON("schemas/json/library-cdnjs.json"),
          "library-filesystem.json": grunt.file.readJSON("schemas/json/library-filesystem.json"),
        }
      }
    },
